    ...
    var e = function() {
        ...
        function t(e, t) {
            ...
            a[0].innerHTML = '<input type="text" class="form-control input-small" style="height: 25px; margin:0px; padding:2px 5px 2px 5px  ;" value="' + n[0] + '">',
                ...
                a[4].innerHTML = '<a class="edit btn blue" style="height: 25px; padding: 2px 5px 2px 5px ;" href="">Guardar</a>',
                a[5].innerHTML = '<a class="cancel btn red" style="height: 25px; padding: 2px 5px 2px 5px ;" href="">Cancelar</a>'
        }

        function n(e, t) {
            var n = $("input", t);
            e.fnUpdate(n[0].value, t, 0, !1),
                e.fnUpdate(n[1].value, t, 1, !1), e.fnUpdate(n[2].value,
                    t, 2, !1), e.fnUpdate(n[3].value, t, 3, !1),
                e.fnUpdate('<a class="edit btn blue" style="height: 25px; padding: 2px 5px 2px 5px ;" href="">Editar</a>', t, 4, !1),
                e.fnUpdate('<a class="delete btn red" style="height: 25px; padding: 2px 5px 2px 5px ;" href="">Eliminar</a>', t, 5, !1), e.fnDraw()
        }
